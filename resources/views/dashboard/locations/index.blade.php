@extends('layout')
@section('title', 'location table | co-55 - Admin Dashboard ')
@section('content')
    <!-- Start Content-->
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 1rem;">
                    ...
                    <div class="col-5">
                        <form action="{{ route('locations.filter') }}" method="get">
                            @csrf
                        ...
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="text-md-right">
                                                <button type="button"
                                                    ...
                                                    <a style="color: white"; href="{{ route('locations.create') }}"><i
                                                            class="mdi mdi-basket mr-1"></i>Add location</a></button>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap table-borderless table-hover mb-0">
                                        ...
                                        <tbody>
                                            @foreach ($locations as $location)
                                                <tr>
                                                    <td class="table-user">
                                                        <img src="{{ asset('assets/img/location/' . $location->image) }}"
                                                    ...
                                                    <td>
                                                        @if ($location->activation == 0)
                                                            <a style="margin-left: 1.5rem"
                                                                href="{{ route('activation.model', ['id' => $location->id, 'model' => Location::class]) }}"><i
                                                    ...
                                                    <td>
                                                        @can('view-locations')
                                                            <a href="{{ route('locations.view', $location->id) }}"><i
                                    ...
                                    <div class="div">{{ $locations->links('pagination::bootstrap-5') }}</div>
