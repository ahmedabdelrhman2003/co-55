@extends('layout')
@section('title', ' create faqs | co-55 - Admin Dashboard ')
@section('content')
                        ...
                        <div class="card-box">
                            ...
                            <form action="{{ route('faqs.store') }}" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="question" value="{{ old('question') }}" id="product-name"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" name="answer" id="product-description" rows="5"
                                        placeholder="Please enter description"value="{{ old('answer') }}"> </textarea>
                                    @error('answer')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
