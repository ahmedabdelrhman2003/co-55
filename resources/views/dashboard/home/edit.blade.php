                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Home Image Edit</li>
                            </ol>
                        </div>
                        <h4 class="page-title"> Edit Home Image</h4>
                    </div>
                </div>
            </div>
            <!-- end page title-->
                        ...
                        <form action="{{ route('home.update', $home->id) }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title" id="product-name" class="form-control"
                                    placeholder="e.g : Apple iMac" value="{{ $home->title }}">
                                @error('title')
                            ...
                            <div class="fallback">
                                <input type="file" name="image" type="file"
                                    value=" {{ asset('assets/img/home/' . $home->image) }}" />
                                @error('image')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
