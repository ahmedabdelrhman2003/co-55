@extends('layout')
@section('title', 'edit role | co-55 - Admin Dashboard ')
@section('content')
    <!-- Start Content-->
                        ...
                        <div class="card-box">
                            ...
                            <form action="{{ route('role.update', $role->id) }}" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" value="{{ $role->name }}" id="product-name"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <label for="exampleFormControlSelect1">permissions<span
                                            class="text-danger">*</span></label>
                                    <select multiple class="form-control" name="permissionId[]"
