...
class ForgotPasswordController extends Controller
{
    ...
    function forgot_password(Request $request)
    {
        ...
        return redirect()->route('auth.forgot')->with('seccess', 'email was sent already');
    }
    ...
    function reset_password(Request $request)
    {
        ...
        if (!$affected) {
            return redirect()->route('auth.reset')->with('faild', 'invalid email');
        }
        ...
        if (!$updated) {
            return redirect()->route('auth.reset')->with('faild', 'error');
        }
    }
}
